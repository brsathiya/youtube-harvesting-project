...
with st.container():
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:root@localhost/youtube', echo=False)
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='root', db='youtube')
